...
public abstract class BeanUtils {
    ...
    public static <T> T instantiate(Class<T> clazz) throws RuntimeException {
        ...
        try {
            ...
            throw new RuntimeException("Failed to instantiate [" + clazz + "]: Is it an abstract class?", ex);
        } catch (IllegalAccessException ex) {
            throw new RuntimeException("Failed to instantiate [" + clazz + "]: Is the constructor accessible?", ex);
        }
    }
    ...
    public static <T> T instantiateClass(Class<T> clazz) throws RuntimeException {
        ...
        try {
            ...
            throw new RuntimeException("Failed to instantiate [" + clazz + "]: No default constructor found", ex);
        }
    }
    ...
    public static <T> T instantiateClass(Class<?> clazz, Class<T> assignableTo) throws RuntimeException {
    ...
    public static <T> T instantiateClass(Constructor<T> ctor, Object... args) throws RuntimeException {
        ...
        try {
            ...
            throw new RuntimeException("Failed to instantiate [" + ctor + "]: Is it an abstract class?", ex);
        } catch (IllegalAccessException ex) {
            throw new RuntimeException("Failed to instantiate [" + ctor + "]: Is the constructor accessible?", ex);
    ...
    public static Method findDeclaredMethod(Class<?> clazz, String methodName, Class<?>... paramTypes) {
        try {
            ...
            if (clazz.getSuperclass() != null) { return findDeclaredMethod(clazz.getSuperclass(), methodName,
                    paramTypes); }
            return null;
        }
    }
    ...
    public static Method findMethodWithMinimalParameters(Method[] methods, String methodName)
        ...
        if (numMethodsFoundWithCurrentMinimumArgs > 1) { throw new IllegalArgumentException("Cannot resolve method '"
                + methodName + "' to a unique method. Attempted to resolve to overloaded method with "
     ...
     * @throws RuntimeException if PropertyDescriptor look fails
     */
    public static PropertyDescriptor[] getPropertyDescriptors(Class<?> clazz) throws RuntimeException {
        try {
     ...
     * @throws RuntimeException if PropertyDescriptor lookup fails
     */
     ...
     * 
     * @param method the method to find a corresponding PropertyDescriptor for, introspecting its declaring class
     * @return the corresponding PropertyDescriptor, or {@code null} if none
     * @throws RuntimeException if PropertyDescriptor lookup fails
     */
    public static PropertyDescriptor findPropertyForMethod(Method method) throws RuntimeException {
     ...
     * @since 3.2.13
     */
    public static PropertyDescriptor findPropertyForMethod(Method method, Class<?> clazz) throws RuntimeException {
    ...
    public static PropertyEditor findEditorByConvention(Class<?> targetType) {
        if (targetType == null || targetType.isArray() || unknownEditorTypes.contains(targetType)) { return null; }
...
//    }
    ...
    /**
     * Check if the given type represents a "simple" property: a primitive, a String or other CharSequence, a Number, a
     * Date, a URI, a URL, a Locale, a Class, or a corresponding array.
     * <p>
    ...
    private static void copyProperties(Object source, Object target, Class<?> editable, String... ignoreProperties)
        ...
        if (editable != null) {
            if (!editable.isInstance(
                    target)) { throw new IllegalArgumentException("Target class [" + target.getClass().getName()
